...
- **GitHub**: https://github.com/Lucy1315/fda-approval-monitor
...
## 📊 NDA/BLA 승인 통계 (FDA 공식 데이터 기준)
### 2025년 12월
- **NDA**: 116건 (최초 10건, 변경 106건)
- **BLA**: 40건 (최초 7건, 변경 33건)
- **소계**: 156건

### 2026년 1월
- **NDA**: 61건 (최초 2건, 변경 59건)
- **BLA**: 13건 (최초 2건, 변경 11건)
- **소계**: 74건

### 총계
- **NDA**: 177건 (최초 12건, 변경 165건)
- **BLA**: 53건 (최초 9건, 변경 44건)
- **전체**: 230건 (최초 21건, 변경 209건)

**상세 보고서**: `/home/user/uploaded_files/FDA_NDA_BLA_Report.xlsx`
...
### 2026-01-27 - 데이터베이스 수정 및 GitHub 연동
- **데이터베이스**: wrangler.jsonc의 중복 D1 바인딩 제거
- **로컬 개발**: 데이터베이스 초기화 및 마이그레이션 정상화
- **테스트 데이터**: 2025-12월 (1건) + 2026-01월 (29건) = 총 30건
- **GitHub 연동**: 저장소 생성 및 초기 커밋 완료
- **필터 기능**: 월별 필터 정상 작동 확인
...
### 완료 ✅
- [x] 월별 데이터 누적 기능 (APPEND 방식)
- [x] 데이터베이스 바인딩 수정 및 정상화
- [x] GitHub 연동 및 저장소 생성
- [x] 월별 필터 기능 (전체/2025-12/2026-01)
